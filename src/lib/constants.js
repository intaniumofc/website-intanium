...
export const ROUTES = {
  ...
  PERFORMANCE_MAP: '/peta-penampilan',
  JOIN_US: '/join',
  // Admin Routes
  ADMIN_LOGIN: '/admin/login',
  ADMIN_DASHBOARD: '/admin/dashboard',
  ADMIN_ABOUT_INTAN: '/admin/about-intan',
  ADMIN_PERFORMANCE_MAP: '/admin/peta-penampilan',
  ADMIN_INTAN_INSIGHTS: '/admin/intan-insights',
  ADMIN_SHINING_STAR: '/admin/milestone',
