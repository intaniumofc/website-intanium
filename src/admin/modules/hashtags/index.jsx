    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-[var(--color-pink)] text-white px-4 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#1a0e8a] transition-colors"
        >
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div>
                  ...
                  <input autoComplete="off" /* autocomplete="off" */ type="text" name="text" value={formData.text} onChange={handleChange} placeholder="Contoh: #IRIS" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--color-pink)]/15 focus:border-[var(--color-pink)] transition-colors" required />
                </div>
                ...
                <div>
                  ...
                  <input autoComplete="off" /* autocomplete="off" */ type="text" name="count" value={formData.count} onChange={handleChange} placeholder="Contoh: 14.2K Tweets" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--color-pink)]/15 focus:border-[var(--color-pink)] transition-colors" />
                </div>
                ...
                <div>
                  ...
                  <select name="row_number"
                    ...
                    className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--color-pink)]/15 focus:border-[var(--color-pink)] transition-colors"
                  >
                ...
                <div>
                  ...
                  <textarea name="explanation" value={formData.explanation} onChange={handleChange} placeholder="Tuliskan penjelasan singkat mengenai tagar ini…" rows={4} className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--color-pink)]/15 focus:border-[var(--color-pink)] transition-colors resize-none" ></textarea>
                </div>

                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-3 bg-[var(--color-pink)] hover:bg-[#1a0e8a] text-white rounded-xl font-bold transition-colors shadow-md shadow-[var(--color-pink)]/20"
                  >
