  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-[#170C79] via-[#2112a3] to-[#0e074e] p-12 text-white overflow-hidden">
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px] select-none">
          {/* Cartoon Characters */}
      ...
      <div className="flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div className="p-3 text-xs font-semibold text-red-500 bg-red-50 border border-red-100 rounded-lg leading-relaxed text-center">
                {error}
              </div>
            )}
