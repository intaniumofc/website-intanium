  ...
  (
    ...
    return (
      ...
      >
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isCurrentUser &&
                    "border-[var(--color-pink)] bg-[var(--color-pink)]/5 border-2 rounded-md",
                  onUserClick &&
                    "hover:bg-[var(--color-pink)]/5 cursor-pointer"
                )}
              >
                ...
                {ranking.avatarUrl ? (
                  ...
                  <div className="bg-[var(--color-pink)]/10 text-[var(--color-pink)] border border-[var(--color-pink)]/20 flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold shrink-0">
        ...
        {showPagination ? (
          <div className="flex items-center justify-between gap-3 border-t border-[var(--color-border)] px-4 py-3 bg-[var(--color-bg-secondary)]">
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white text-[var(--color-heading)] font-bold rounded-md border border-[var(--color-border)] px-2 py-1 text-xs cursor-pointer focus:outline-none"
              >
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="hover:bg-[var(--color-pink)]/5 rounded-md border border-border px-2 py-1 h-8 w-8 transition-colors disabled:cursor-not-allowed disabled:opacity-50"
              >
