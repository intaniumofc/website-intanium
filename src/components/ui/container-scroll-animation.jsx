...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto w-full border border-white/10 p-2 md:p-3 bg-gradient-to-b from-white/10 to-transparent backdrop-blur-md rounded-[32px] shadow-2xl relative z-10"
    >
