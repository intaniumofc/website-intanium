        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.youtube.com https://s.ytimg.com https://www.googletagmanager.com https://static.cloudflareinsights.com",
              ...
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.r2.dev https://*.tile.openstreetmap.org https://*.openstreetmap.org https://*.basemaps.cartocdn.com https://cloudflareinsights.com",
